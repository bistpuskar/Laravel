...
<head>
  ...
  <link rel="stylesheet" href="{{asset('admin-panel/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')}}">
...
<!-- jQuery UI 1.11.4 -->
<script src="{{asset('admin-panel/bower_components/jquery-ui/jquery-ui.min.js')}}"></script>
